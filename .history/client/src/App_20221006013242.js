...
const App = () => {
  ...
  const removeCurrentFollowing = (deletedFollowee) => {
    ...
    // copyOfCurrentUser.followees.filter((followee) => parseInt(followee.followee_id) !== parseInt(deletedFollowee.followee_id))
    copyOfCurrentUser.followees = copyOfCurrentUser.followees.filter(followee => followee.followee_id !== deletedFollowee.followee_id)
    setCurrentUser(copyOfCurrentUser)
    console.log(copyOfCurrentUser)
  }
